...
world_type_table[3:3+1] = ["Standard (Chthonian)", "Small (Hadean)", "Standard (Garden)"]
world_type_table[4:4+1] = ["Standard (Chthonian)", "Small (Ice)", "Standard (Garden)"]
world_type_table[5:5+1] = ["Standard (Greenhouse)", "Small (Rock)", "Standard (Garden)"]
world_type_table[6:6+1] = ["Standard (Greenhouse)", "Small (Rock)", "Standard (Garden)"]
...
world_type_table[10:10+1] = ["Standard (Ammonia)", "Tiny (Ice)", "Standard (Garden)"]
world_type_table[11:11+1] = ["Standard (Ammonia)", "Asteroid Belt", "Standard (Garden)"]
world_type_table[12:12+1] = ["Standard (Ammonia)", "Asteroid Belt", "Standard (Garden)"]
world_type_table[13:13+1] = ["Large (Ammonia)", "Standard (Ocean)", "Standard (Garden)"]
world_type_table[14:14+1] = ["Large (Ammonia)", "Standard (Ocean)", "Standard (Garden)"]
world_type_table[15:15+1] = ["Large (Greenhouse)", "Standard (Ice)", "Standard (Garden)"]
world_type_table[16:16+1] = ["Large (Greenhouse)", "Standard (Hadean)", "Standard (Garden)"]
...
society_types_table[7:8+1] = ["Clan/Tribal", "Clan/Tribal", "Clan/Tribal", "Clan/Tribal"]
...
society_types_table[13:13+1] = ["Dictatorship", "Dictatorship", "Dictatorship", "Theocracy"]
society_types_table[14:14+1] = ["Dictatorship", "Dictatorship", "Dictatorship", "Dictatorship"]
society_types_table[15:15+1] = ["Dictatorship", "Representative Democracy", "Dictatorship", "Dictatorship"]
society_types_table[16:16+1] = ["Representative Democracy", "Representative Democracy", "Representative Democracy", "Dictatorship"]
society_types_table[17:17+1] = ["Representative Democracy", "Representative Democracy", "Representative Democracy", "Dictatorship"]
society_types_table[18:18+1] = ["Representative Democracy", "Representative Democracy", "Athenian Democracy", "Representative Democracy"]
society_types_table[19:19+1] = ["Athenian Democracy", "Representative Democracy", "Corporate State", "Representative Democracy"]
society_types_table[20:20+1] = ["Athenian Democracy", "Athenian Democracy", "Corporate State", "Corporate State"]
society_types_table[21:21+1] = ["Corporate State", "Athenian Democracy", "Corporate State", "Corporate State"]
society_types_table[22:22+1] = ["Corporate State", "Athenian Democracy", "Technocracy", "Corporate State"]
society_types_table[23:23+1] = ["Technocracy", "Corporate State", "Technocracy", "Technocracy"]
society_types_table[24:25+1] = ["Technocracy", "Technocracy", "Technocracy", "Technocracy"]
