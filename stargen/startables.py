"""
GURPS Space 4th Edition Advanced Worldbuilding tables

This module contains all the applicable tables from the Generating Star Systems
...
most ranges are notated as [start:end+1] for human clarity. Due to this and
to fit the data structure better in some places the tables have been modified
or omitted.

Notably the Star Masses table is actually a nested table that requires multiple
rolls, because of that it is the least straight forward of the tables.

The Stellar Evolution table has been modified to take ranges of stellar
masses instead of discrete values. This allows for easier calculations in
multi-star system generation.

A 'reversed' Stellar Evolution table exists to look up Spectral Type by
temperature ranges.

The Orbital Separation, Stellar Orbital Eccentricity, Gas Giant Size,
Orbit Contents, and Moon Size tables have had their lower or upper bounds
adjusted to allow for stacking modifiers taking them beyond their normal
ranges.

Todo:
    * Decide whether to have this file contain the entirety of the 
        advanced worldbuilding tables, or just the Star Systems section
"""
...
stellar_mass_table_first_roll[
    10 : 10 + 1
] = stellar_mass_table_first_roll_10_second_roll
stellar_mass_table_first_roll[
    11 : 11 + 1
] = stellar_mass_table_first_roll_11_second_roll
stellar_mass_table_first_roll[
    12 : 12 + 1
] = stellar_mass_table_first_roll_12_second_roll
stellar_mass_table_first_roll[
    13 : 13 + 1
] = stellar_mass_table_first_roll_13_second_roll
stellar_mass_table_first_roll[
    14 : 18 + 1
] = stellar_mass_table_first_roll_14_second_roll

# Garden World First Roll table
stellar_mass_table_first_roll_garden_world = IntervalTree()
stellar_mass_table_first_roll_garden_world[
    1 : 1 + 1
] = stellar_mass_table_first_roll_5_second_roll
stellar_mass_table_first_roll_garden_world[
    2 : 2 + 1
] = stellar_mass_table_first_roll_6_second_roll
stellar_mass_table_first_roll_garden_world[
    3 : 4 + 1
] = stellar_mass_table_first_roll_7_second_roll
stellar_mass_table_first_roll_garden_world[
    5 : 6 + 1
] = stellar_mass_table_first_roll_8_second_roll
